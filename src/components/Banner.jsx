...
function Banner() {
  return (
    <>
      ...
      <div
       className="max-w-screen-2xl mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-1/2  mt-12 md:mt-32">
        <div className="space-y-12">
        <h1 className="text-4xl font-bold">Hello, wellcome here to learn <span className=" text-pink-500"> new everyday</span></h1> 
  ...
  <svg
    ...
    <path
      d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" />
        ...
        <img src={banner} className="w-92 h-92" alt="image of book" /></div>
      </div>
